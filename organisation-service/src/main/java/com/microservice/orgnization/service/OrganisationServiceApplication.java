package com.microservice.orgnization.service;
...
@OpenAPIDefinition(
		info = @Info(
				title = "Rest API design for Organization microservice",
				description = " Organization microservice REST APIs Documentation",
				version = "v1.0",
				contact = @Contact(
